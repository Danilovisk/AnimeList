        ...
        <div class="mb-4">
            <div class="flex justify-end">
                <a href="{{ route('mangas.create')}}"
                    class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Create Manga</a>
            </div>
        </div>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                    <form action="{{ route('mangas.destroy',$manga->id) }}" method="POST" onsubmit="return confirm('{{ trans('Are you sure ? ') }}');">
