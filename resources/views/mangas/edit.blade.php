    ...
    <div class="font-sans antialiased">
        <div class="flex flex-col items-center min-h-screen pt-6 bg-gray-100 dark:bg-gray-900 sm:justify-center sm:pt-0">
            ...
            <div class="w-full px-16 py-20 mt-6 overflow-hidden bg-white dark:bg-gray-800 rounded-lg lg:max-w-4xl">
                ...
                <div class="mb-4">
                    <h1 class="font-sans antiliased text-3xl font-bold text-gray-800 dark:text-gray-200">Edit Manga</h1>
                </div>
                    ...
                    <form method="POST" action="{{ route('mangas.update',$manga->id) }}">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="title" placeholder="255" value="{{old('title',$manga->title)}}">
                            @error('title')
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                rows="4" placeholder="400"> {{old('description', $manga->description)}}</textarea>
                            @error('description')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div>
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="author" placeholder="255" value="{{old('author',$manga->author)}}">
                            @error('author')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div>
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="chapters" placeholder="255" value="{{old('chapters',$manga->chapters)}}">
                            @error('chapters')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
                        ...
                        <div>
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="date" name="started_at" placeholder="255" value="{{old('started_at',$manga->started_at)}}">
                            @error('started_at')
                            <span class="text-red-600 text-sm">
                                {{ $message }}
                            </span>
