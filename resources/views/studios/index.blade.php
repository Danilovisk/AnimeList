        ...
        <div class="mb-4">
            <div class="flex justify-end">
                <a href="{{ route('studios.create')}}"
                    class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Create Studio</a>
            </div>
        </div>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    {{ $studio->established_at }}
                                <td
                                    class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                                    <span> {{ $studio->created_at }}</span>
                                </td>
                                ...
                                <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                    <form action="{{ route('studios.destroy',$studio->id) }}" method="POST" onsubmit="return confirm('{{ trans('Are you sure ? ') }}');">
